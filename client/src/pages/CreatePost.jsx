            ...
            <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
                ...
                <div className="mt-5 flex gap-5">
                    <button
                        ...
                        className='text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center transition-all ease-in delay-75 hover:bg-green-800 hover:text-gray-200'
                    >
                        {
                ...
                <div className="mt-10">
                    ...
                    <button
                        type='submit'
                        className='mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center transition-all ease-in delay-75 hover:bg-[#565cff] hover:text-gray-100'
                    >
                        {
